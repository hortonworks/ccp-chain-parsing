...
import com.cloudera.parserchains.queryservice.model.define.RouteSchema;
...
public class DefaultChainBuilderService implements ChainBuilderService {
    ...
    public DefaultChainBuilderService(ParserBuilder parserBuilder, ParserCatalog parserCatalog) {
